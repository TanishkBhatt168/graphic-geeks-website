        ...
        <div className="animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-white text-white hover:bg-white hover:text-primary font-semibold px-8 py-3 rounded-full text-lg"
            >
              Join Now
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            >
              <Code className="h-12 w-12 text-white mb-4 mx-auto" />
              <h3 className="text-xl font-semibold mb-2">Multiple Domains</h3>
              <p className="text-blue-100">Web Dev, AI/ML, Android, and more</p>
            </div>
            <div
              className="glass-card p-6 rounded-2xl animate-slide-up"
              style={{ animationDelay: "0.4s" }}
            >
              <Trophy className="h-12 w-12 text-white mb-4 mx-auto" />
              <h3 className="text-xl font-semibold mb-2">Award Winning</h3>
              <p className="text-blue-100">Multiple hackathon victories</p>
            </div>
          </div>
        </div>
      </div>
